...
export default async function SharedDocumentPage({
  ...
  return (
    <main className="space-y-6">
      <section className="rounded-2xl border bg-background p-6 shadow-sm dark:border-neutral-800 ">
      ...
      <section className="rounded-2xl border bg-background p-4 shadow-sm dark:border-neutral-800">
