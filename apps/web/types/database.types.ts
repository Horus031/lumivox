...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      evaluate_engagement_streak_states: { Args: never; Returns: Json }
      ...
      get_cms_settings: { Args: { p_keys: string[] }; Returns: Json }
      ...
      get_my_dashboard_activity: { Args: { p_days?: number }; Returns: Json }
      get_my_goals_with_progress: { Args: never; Returns: Json }
